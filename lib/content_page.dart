// ignore_for_file: no_leading_underscores_for_local_identifiers, prefer_const_constructors, prefer_const_literals_to_create_immutables, unused_local_variable, use_build_context_synchronously, sized_box_for_whitespace, avoid_unnecessary_containers, unnecessary_import, library_private_types_in_public_api
...
import 'package:getxappui/recent_contest.dart';
              ...
              child: Container(
                ...
                child: Row(
                  children: [
                    CircleAvatar(
                      radius: 40,
                      backgroundImage: AssetImage(info[3]['img']),
                    ),
                    SizedBox(
                      width: 10,
                    ),
